...
%% wild type
model_1 = model;
model_1 = changeRxnBounds(model_1,{'EX_glc__D_e','EX_o2_e','EX_g6p_e'...
    ,'EX_xyl__D_e'},[-10-15 0 0],{'l','l','l','l'});
...
% model_1 = changeRxnBounds(model_1, {'EX_glc__D_e','EX_o2_e'},[-10, -15],'l');
model_1 = model;
model_1 = changeRxnBounds(model_1,{'EX_glc__D_e','EX_o2_e','EX_g6p_e'...
    ,'EX_xyl__D_e'},[-10 -15 0 0],{'l','l','l','l'});
% model_1 = changeObjective(model_1, {'EX_g6p_e','BIOMASS_Ec_iJO1366_core_53p95M'}...
%     ,[0.154,4.1408]);
model_1 = changeObjective(model_1,'EX_succ_e');%
