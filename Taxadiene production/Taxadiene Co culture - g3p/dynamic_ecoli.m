...
model_up = changeRxnBounds(model_up,{'EX_glc__D_e','EX_o2_e','EX_xyl__D_e','EX_g3p_e'}...
    ,[-vg -0.8*15 0 0],{'l','l','l','l'});
[F_up,v_g_up,vz_up,v_int_up,v_o_up] = fba_g3p(model_up);
% v_g_up
% v_int_up
%% txdn production
...
[F_down,v_g_down,vz_down,v_int_down,v_txdn,v_o_down] = fba_txdn(model_down);
% v_int_down
%% equations
